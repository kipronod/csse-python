...
class Organization(db.Model):
    ...
    memberOf = db.Column('sch:memberOf', db.String(100))
    subClassOf = db.Column('rdfs:subClassOf', db.String(100))
    ...
    addressCountry = db.Column('addressCountry', db.String(100))
    streetAddress = db.Column('streetAddress', db.String(100))
    postalCode = db.Column('postalCode', db.String(100))
    addressLocality = db.Column('addressLocality', db.String(100))
    hasOutcomeS = db.Column('hasOutcomeS', db.String(1000))
    hasIndicatorS = db.Column('hasIndicatorS', db.String(1000))
    ...
    blackOwned = db.Column(db.Boolean, unique=False, default=True)
    indigenousOwned = db.Column(db.Boolean, unique=False, default=True)
    womanOwned = db.Column(db.Boolean, unique=False, default=True)
...
class Impact(db.Model):
    ...
    forStakeHolderS = db.Column('forStakeHolderS', db.String(1000))
    hasImportanceS = db.Column('hasImportanceS', db.String(1000))
    underServedS = db.Column('underServedS', db.String(1000))
    definedBy = db.Column('definedBy', db.String(1000))
    dateCreated = db.Column('sch:dateCreated', db.DateTime, default=datetime.datetime.now)
    provider = db.Column('sch:provider', db.String(100))

    def __init__(self, identifier, name, description, forStakeHolderS, hasImportanceS, underServedS, definedBy, dateCreated, provider):
        self.identifier = identifier
        self.name = name
        self.description = description
        self.forStakeHolderS = forStakeHolderS
        self.hasImportanceS = hasImportanceS
        self.underServedS = underServedS
...
class BeneficiaryStakeholder(db.Model):
    ...
    name = db.Column('sch:name', db.String(100))
    description = db.Column('sch:description', db.String(1000))
    location = db.Column('sch:location', db.String(1000))
